    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExecutorOfProjectsId = table.Column<int>(type: "INTEGER", nullable: false),
                    ExecutorsId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectExecutors", x => new { x.ExecutorOfProjectsId, x.ExecutorsId });
                    table.ForeignKey(
                        name: "FK_ProjectExecutors_Employees_ExecutorsId",
                        column: x => x.ExecutorsId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectExecutors_Projects_ExecutorOfProjectsId",
                        column: x => x.ExecutorOfProjectsId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectExecutors_ExecutorsId",
